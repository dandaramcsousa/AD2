...
Para a importância das variáveis de cada modelo, vamos observar os seguintes gráficos e já modificar de acordo com a não importância de variáveis.
```{r}
...
**Re-treino do melhor modelo (usando os melhores valores de parâmetros encontrados em todos os dados, sem usar validação cruzada). (9 pts.)**

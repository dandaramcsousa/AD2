...
```
UF, partido, total_receita, total_despesa, grau, estado_civil, media_receita, media_despesa, quantidade_doacoes, quantidade_doadores, quantidade_despesas, quantidade fornecedores, idade, sexo
...
dataVotos.model.new <- dataVotos.rm %>%
  dplyr :: select(
    UF, partido, total_receita, total_despesa, grau, estado_civil, media_receita, media_despesa, quantidade_doacoes, quantidade_doadores, quantidade_despesas, quantidade_fornecedores, idade, sexo, votos
  )
